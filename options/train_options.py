...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--GA_freeze_layer', type=int, default=0, help='freeze these many initial layers (inclusive) of GA network during training')
        parser.add_argument('--GB_freeze_layer', type=int, default=0, help='freeze these many initial layers (inclusive) of GB network during training')
        parser.add_argument('--DA_freeze_layer', type=int, default=0, help='freeze these many initial layers (inclusive) of DA network during training')
        parser.add_argument('--DB_freeze_layer', type=int, default=0, help='freeze these many initial layers (inclusive) of DB network during training')
